    ...
    return (
        <div className="search">
            <form className='form' onSubmit={searchHandler}>
                ...
                <Link to="/search-result"><button type="submit">Search</button></Link>
            </form>
            ...
            <div className="cart">
                 <Link to='/cart' style={{textDecoration:'none'}}><p>cart&nbsp;&nbsp;<FaShoppingCart style={{color:'var(--text-color)', fontSize:'20px'}}/></p></Link>
            </div>
